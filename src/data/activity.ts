export const activityData = [
  ...
  {
    user: "Lana Steaver",
    action: "Purchased SEO Masterclass",
    online: false,
    image:
  ...
  {
    user: "Alia Lane",
    action: "Purchased Figma Mockups",
    online: false,
    image:
  ...
  },
  {
    ...
    online: false,
    image:
      "https://media.istockphoto.com/id/1855019705/photo/happy-black-woman-phone-and-communication-for-social-media-against-a-blue-studio-background.jpg?s=612x612&w=0&k=20&c=q37dd2ii8OmYQ1vKBL1Jq5SPfKPgYM3bVpKBwcMSUkk=",
  },
  {
    user: "Drew Kane",
    action: "Purchased Webflow 101",
  ...
  {
    user: "Marco D'Souza",
    action: "Purchased JavaScript Essentials",
    online: false,
    image:
      "https://www.hsfkramer.com/dam/jcr:17f41fec-75d9-4f4f-834c-890ebb848cac/marco-de-sousa_WEB.jpg",
  },
  {
    user: "Emily Johnson",
    action: "Attended Live Coding Bootcamp",
    online: true,
    image:
  ...
  {
    user: "Yuki Tanaka",
    action: "Purchased React Native Course",
    online: false,
    image:
  ...
  },
  {
    ...
    online: true,
    image:
      "https://images.unsplash.com/photo-1595152772835-219674b2a8a6?auto=format&fit=crop&w=256&q=80",
  },
  {
    user: "Hannah Kim",
    action: "Downloaded UX Resources",
    online: false,
    image:
