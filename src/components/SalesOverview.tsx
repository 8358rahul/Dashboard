...
function StatCard({
  ...
  return (
    <Card className="bg-white dark:bg-zinc-900 border dark:border-zinc-800 rounded-xl shadow-sm p-5 flex flex-col justify-between min-w-[220px] h-[120px]">
      ...
      <div className="flex items-end justify-between flex-1">
        ...
        <Badge
          className={`flex items-center gap-1 px-2 py-0.5 text-xs font-medium border-none 
            ${
              positive === undefined
                ? ""
                : positive
